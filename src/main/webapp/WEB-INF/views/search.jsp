        ...
        <div id="wrapper" class="wrapper">
            ...
            <section class="recipe-without-sidebar-wrap padding-top-80 padding-bottom-22">
                <div class="container">
                            ...
                            <form action="SearchAllRecipeController"
                                ...
                                <div class="btn-group" style="display: inline-block">
                                    <div class="input-group-btn">
                                        <button type="submit" value="Search" name="btAction"
                                                class="custom-btn-thongnt">Search</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <c:forEach var="categoryDto" items="${categoryDtoList}"
                                            ...
                                            <li style=" display: inline; width: fit-content; ">
                                                <div class="checkbox checkbox-primary"
                                                    ...
                                                    <input id="checkbox-${categoryDto.categoryId}"
                                                           type="checkbox" value="${categoryDto.name}"
                                                           name="category-checkboxs">
                                                    <label
                                                        for="checkbox-${categoryDto.categoryId}">${categoryDto.name}</label>
                                                </div>
                                            </li>
                                            <!-- forEach end here -->
                                        </c:forEach>
                    ...
                    <div class="row">
                        <c:set var="searchNotFound" value="${requestScope.SEARCH_NOT_FOUND}"></c:set>
                        <c:if test="${searchNotFound  == '1'}">
                            <div class="col-12">
                                <p>
                        ...
                        <c:if test="${searchNotFound == '-1'}">
                            <div class="col-12">
                                <p>
                                    You have not typed anything! We suggest some post for you ...
                                </p>
                            </div>
                        </c:if>
                        ...
                        <c:if test="${not empty searchResult}">
                            <c:if test="${searchResult.size() > 9}">
                                ...
                                <div class="col-12 text-center">
                                    <button id="search-result-loadmore-btn" class="custom-btn-thongnt"
